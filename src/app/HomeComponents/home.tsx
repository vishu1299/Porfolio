    ...
    <>
      <div className="bg-[#1E1E1F] h-auto pb-5 xl:w-[67%]  rounded-xl border border-[#383838] shadow-custom mt-8 xl:mt-0 ">
        {nav.map((Value, index) => (
          <div
            key={index}
            className="lg:flex justify-end  gap-x-6 p-3 bg-[#282829] nav_radius hidden"
          >
        ...
        <div className="xl:p-8 p-3 ">
          ...
          <section className=" text-gray-300 leading-5	pt-5 font-normal">
            <p className="text-[16px]">
              As a frontend enthusiast, I thrive on transforming intricate
              designs into seamless and captivating user experiences
            </p>
            <br />
            <p>
              Leveraging my expertise in HTML, CSS, and JavaScript, I am
              committed to pushing the boundaries of frontend development and
              delivering innovative solutions that delight users and exceed
              expectations.
            </p>
          </section>
          <div className="pt-8">
            ...
            <section className="grid grid-cols-1 xl:grid-cols-2 gap-4 pt-6 gap-y-5">
              <div className="flex flex-col xl:flex-row gap-3 bg-[#212123] rounded-xl p-6 shadow-custom">
                ...
                <div className="text-white flex flex-col gap-y-2">
                  ...
                  <p className="text-[12px] text-gray-300">
                    Developed intuitive and user-friendly interfaces by applying
                    user-centered design principles and conducting user research
                  </p>
                </div>
              </div>
              <div className="flex gap-3 bg-[#212123] rounded-xl p-6 shadow-custom">
                ...
                <div className="text-white flex flex-col gap-y-2">
                  ...
                  <p className="text-[12px] text-gray-300">
                    Proficient in React.js with experience building dynamic,
                    single-page applications (SPAs) that enhance user
                    engagement.
                  </p>
                </div>
              </div>
              <div className="flex gap-3 bg-[#212123] rounded-xl p-6 shadow-custom">
                ...
                <div className="text-white flex flex-col gap-y-2">
                  ...
                  <p className="text-[12px] text-gray-300">
                    Designed and developed mobile-first web pages, ensuring that
                    the user experience is optimized for mobile devices before
