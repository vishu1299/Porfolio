            ...
            <div className=" xl:pb-10 xl:w-[23%] w-full ">
                <div className="bg-[#1E1E1F] rounded-xl border border-[#383838] ">
                    <div className="bg-[#383838] border-[#E3C08D] border-t-2 border-l-2  flex justify-end max-w-max float-end p-1 nav_radius1 xl:hidden ">
                        <Image className='flex sm:hidden' onClick={toggleData}
                            src={menuDown}
                            height={20}
                            alt="Menu"
                        />
                        <h1 onClick={toggleData} className=' text-white text-xs my-auto hidden sm:flex xl:hidden sm:p-1'>Show Contacts</h1>
                    </div>
                    <div className="xl:p-5 p-5 ">
                        ...
                        <div className={`${showdata ? 'grid' : 'hidden'}  sm:grid-cols-2 xl:grid-cols-1 xl:flex flex-col gap-y-10 pt-8 `}>
                            ...
                            <div className="flex justify-start items-center gap-3 ">
                                ...
                                <div className=" my-auto">
                                    ...
                                    <a href="mailto:vishvasgupta2002@gmail.com" className="text-[14px] text-white">vishvasgupta2002gmail.com</a>
                                </div>
                            </div>
                    ...
                    <div className={`bg-[#E8AA50] p-2 sm:p-5 mt-4 justify-center rounded-b-2xl xl:flex ${showdata ? 'flex' : 'hidden'}`}>
