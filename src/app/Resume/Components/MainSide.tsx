      ...
      <div className="bg-[#1E1E1F] h-auto pb-5 xl:w-[67%]  rounded-xl border border-[#383838] shadow-custom mt-8 xl:mt-0">
        {nav.map((Value, index) => (
          ...
          >
            ...
            <Link className="text-[#E3C08D]" href="/Resume">
              {Value.head2}
            </Link>
            <Link
        ...
        <div className="xl:p-8 p-2 sm:p-6 xl:text-justify">
          ...
          <div className="flex justify-start items-center gap-3 pt-10">
            <div className="bg-[#202022] shadow-custom rounded-xl p-3">
              <Image src={Education} height={30} alt="Picture of the author" />
            </div>
          ...
          <div className="relative border-l border-gray-700 ml-6 mt-8">
            <div className="mb-10 ">
              ...
              <div className="pl-8">
                ...
                <p className="text-gray-500">
                  Pursuing my Masters Degree in Computer science from Ganga
                  Institute of Technology and Management – Jhajjar,HR
                </p>
              </div>
            </div>
            <div className="mb-10 ">
              ...
              <div className="pl-8">
                ...
                <p className="text-gray-500">
                  Completed my Bachelors Degree in Computer Science from Vaish
                  College of Engineering – Rohtak, HR and secured First Division
                  with Distinction
                </p>
              </div>
            </div>
            <div className="mb-10 ">
              ...
              <div className="pl-8">
                ...
                <p className="text-gray-500">
                  Completed higher secondary education from Bal Bharti School,
                  Bahadurgarh and achieved 82%.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-start items-center gap-3 pt-10">
            <div className="bg-[#202022] shadow-custom rounded-xl p-3">
              <Image src={experience} height={30} alt="Picture of the author" />
            </div>
            <div className="my-auto">
            ...
            <div className="mb-10 ">
              ...
              <div className="pl-8">
                <p className="text-gray-400">
                  Xcrino Business Solutions(Present)
                </p>
                <h3 className="text-white text-lg font-semibold">
                  Frontend Developer
                </h3>
                <p className="text-gray-500">
                  I currently hold the position of Frontend Developer, focusing
                  on Various Projects employing a diverse array of technologies
                </p>
                <br />
                <p className="text-gray-500">
                  Within this role, I have been responsible for designing and
                  implementing the website interface, ensuring optimal
                  functionality across various devices, including mobile,
                  desktop, and tablets.
                </p>
              </div>
            </div>
          ...
          <div className="flex justify-start items-center gap-3 pt-10 pb-10">
            <div className="bg-[#202022] shadow-custom rounded-xl p-3">
              <Image src={skills} height={30} alt="Picture of the author" />
            </div>
            <div className="my-auto">
          ...
          <div className="grid grid-cols-3 gap-6 pt-8">
            <div className="bg-[#121212] absolute rounded-3xl  w-[15%]">
              <div className="flex justify-between relative bottom-7 ">
                <div className=" ">
                  <Image src={js} alt="Js icons" />
                </div>
                <div className="bg-[#1E1E1F] shadow-custom rounded-full p-3 w-12 h-12 flex items-center justify-center">
                  1
                </div>
              </div>
            </div>
